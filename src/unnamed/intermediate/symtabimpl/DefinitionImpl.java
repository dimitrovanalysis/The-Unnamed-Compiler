...
import unnamed.intermediate.Definition;
...
public enum DefinitionImpl implements Definition {
    CONSTANT, LOCAL_CONSTANT, ENUMERATION_CONSTANT("enumeration constant"),
    TYPE, VARIABLE, LOCAL_VARIABLE, FIELD("record field"),
