...
public class TypeChecker {
    ...
    /**
     * Check if a type specification is undefined.
     *
     * @param type the type specification to check.
     * @return true if undefined or null, else false.
     */
    public static boolean isUndefined(TypeSpec type) {
        return (type == null) || (type.baseType() == Predefined.undefinedType);
    }
     ...
     * @param type1     the first type specification to check.
     * @param type2     the second type specification to check.
     * @param isEqualOp is equal or relative comparison.
    ...
    public static boolean areComparisonCompatible(TypeSpec type1,
        ...
        // Two identical types when equal operation
        else if (isEqualOp) {
